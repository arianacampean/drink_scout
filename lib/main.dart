...
class _MyHomePageState extends State<MyHomePage> {
  ...
  FutureBuilder<List<Drinks>> _buildBodyy(BuildContext context) {
  ...
  FutureBuilder<List<Drinks>> _buildBody(BuildContext context) {
    ...
    return FutureBuilder<List<Drinks>>(
      ...
      builder: (context, snapshot) {
        ...
        log(webViewReady.toString());
        if (snapshot.connectionState == ConnectionState.done) {
          // log(snapshot.data[1]['nume'].toString());
          //log(snapshot.toString());
          final List<Drinks>? posts = snapshot.data;
          //log(posts![1].nume);
          // log(posts!.data[1]['nume'].toString());
